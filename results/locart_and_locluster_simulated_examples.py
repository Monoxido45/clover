    ...
    **kwargs
    ...
    for n in n_train:
        ...
        if not (
            ...
            mean_int_length_vector, median_int_length_vector = (
                np.zeros((n_it, 5)),
                np.zeros((n_it, 5)),
            )
            mean_diff_vector, median_diff_vector = (
                np.zeros((n_it, 5)),
                np.zeros((n_it, 5)),
            )
            mean_coverage_vector, median_coverage_vector = (
                np.zeros((n_it, 5)),
                np.zeros((n_it, 5)),
            )
            ...
            for i in range(n_it):
                ...
                if type_score == "regression":
                    ...
                    mean_diff_vector[i, 2], median_diff_vector[i, 2] = (
                        np.mean(np.abs(icp_cond_r_real - (1 - sig))),
                    ...
                    mean_diff_vector[i, 3], median_diff_vector[i, 3] = (
                        np.mean(np.abs(wicp_cond_r_real - (1 - sig))),
